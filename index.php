...
switch ($_SESSION['page']){
    case 'aboutCompany':
        ...
        $meta_kw = 'О компании, интер, инструмент, производство, история';
    ...
    case 'products':
        $title = 'Интер Инструмент - Продукция - Качественный металлорежущий инструмент, оснастка, токарные пластины, оборудование';
        ...
        break;
    case 'equipment':
        $title = 'Интер Инструмент - Оборудование - станки с ЧПУ от Yida, SINGULAR MACHINERY, Palmary Machinery Co, Днепропетровск, Украина';
        ...
        break;
    case 'snap-in':
        $title = 'Интер Инструмент - Оснастка - Инструмент для станков от производителей Eroglu, Rohm, Acrow, Днепропетровск, Украина';
        ...
        $meta_kw = 'Высокоточный, инструмент, фрезерный, сверлильно-расточной, Eroglu, Rohm, Acrow';
        $_SESSION['section']='products';
        break;
    case 'tool':
        $title = 'Интер Инструмент - Инструмент - MITSUBISHI CARBIDE, CERAMTEC, WINSTAR - официальные поставщики в Украине';
    ...
    //***********END PRODUCTS SECTION***
    case 'email_us':
        $title = 'Интер Инструмент - Написать нам';
        $meta_d = 'Контакты';
        $meta_kw = 'Контакты';
