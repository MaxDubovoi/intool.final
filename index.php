...
switch ($_SESSION['page']){
    ...
    case 'products':
        $title = 'Интер-инструмент - Продукция';
        ...
        $meta_kw = 'Продукция, металлорежущий, инструмент, оснастка, производство, оборудование';
    ...
    case 'snap-in':
        ...
        $meta_kw = 'Высокоточный, инструмент, фрезерный, сверлильно-расточной';
        $_SESSION['section']='products';
        break;
    case 'tool':
        ...
        $meta_kw = 'японский, поставщик, режущий, твердосплавный, спектр, строительство, прозвидитель';
        $_SESSION['section']='products';
        break;
